...
public class BigQueryExportInterpreter extends Interpreter {
  ...
  private static Logger logger = LoggerFactory.getLogger(BigQueryExportInterpreter.class);
  ...
  private BigQuery createAuthorizedClient() throws IOException {
    ...
    BigQueryOptions options = BigQueryOptions.newBuilder()
        ...
        .setProjectId(getProperty(PROJECT_ID)).build();
